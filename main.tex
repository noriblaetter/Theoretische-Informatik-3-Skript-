...
\begin{figure}
    \centering
    \includegraphics[width=0.25\linewidth]{images/quicksort-recursion-tree.png}
    \caption{QuickSort Recursion Tree}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/recursive-tree-median.png}
    \caption{Recursive Tree with Median}
    \label{fig:enter-label}
\end{figure}
\[
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/hash-table-example.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/perfect-hashing-two-level.png}
    \caption{Two-Level Perfect Hashing Solution}
    \label{fig:enter-label} 
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/graph-isomorphism-example.png}
    \caption{Example of Isomorphic Graphs}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/skip-list-structure.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/game-tree-evaluation.png}
    \caption{Game Tree Evaluation}
    \label{fig:enter-label}
\end{figure}
\begin{verbatim}
...
\begin{proof}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{images/proof-min-node.png}
        \caption{Proof for Min Node}
        \label{fig:enter-label}
    \end{figure}
...
\begin{proof}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{images/tree-split-amortized.png}
        \caption{Tree Split for Amortized Analysis}
        \label{fig:enter-label}
    \end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/tree-insertion-path.png}
    \caption{Tree Insertion Path}
    \label{fig:enter-label}
\end{figure}
\begin{lem}
...
\begin{figure}
     \centering
     \includegraphics[width=0.5\linewidth]{images/linear-programming-geometric.png}
     \caption{Linear Programming - Geometric Instance}
     \label{fig:enter-label}
 \end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/lp-constraints-pruning.png}
    \caption{LP Constraints - Pruning H-up and H-down}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/lp-oracle-vertical.png}
    \caption{LP Oracle with Vertical Line}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/unused-image-3.png}
    \caption{LP Constraints in 3D}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/lp-oracle-implementation.png}
    \caption{LP Oracle Implementation}
    \label{fig:enter-label}
\end{figure}
\begin{enumerate}
